...
export const CANONICAL_NOMENCLATURE: Record<string, CanonicalLabel> = {
  ...
  L3: { name: "Loaded Length at Critical Release", sym: "L₃" },
  L4: { name: "Loaded Length at Coupled-Travel End", sym: "L₄" },

  // Travel
  s_h: { name: "Hammer Run-Up Stroke", sym: "sₕ" },
  s: { name: "Hammer Run-Up Stroke", sym: "s" },
  y_latch: { name: "Critical Release Travel", sym: "ycritical" },
  y: { name: "Critical Release Travel", sym: "ycritical" },
  y_total: { name: "Total Coupled Travel", sym: "ytotal" },
  y_post: { name: "Remaining Post-Critical Travel", sym: "ypost" },
  ...
  F3: { name: "Spring Force at Critical Release", sym: "F₃" },
  F4: { name: "Spring Force at Coupled-Travel End", sym: "F₄" },
  F_end_min: { name: "Minimum End Spring Force", sym: "Fend,min" },
  F_opposing: { name: "Opposing Latch Preload", sym: "Fopp" },
  F4_net: { name: "Net End Driving Force", sym: "F₄,net" },
  F1_cap: { name: "Starting Force Cap", sym: "F₁,cap" },

  // Work / energy
  W_run: { name: "Hammer Run-Up Work", sym: "Wᵣᵤₙ" },
  Whammer: { name: "Hammer Run-Up Work", sym: "Wᵣᵤₙ" },
  Wlatch: { name: "Critical-Window Spring Work", sym: "Wcritical" },
  W_critical: { name: "Critical-Window Spring Work", sym: "Wcritical" },
  W_post: { name: "Post-Critical Spring Work", sym: "Wpost" },
  W_opposing: { name: "Opposing-Preload Work", sym: "Wopp" },
  W_post_net: { name: "Net Post-Critical Work", sym: "Wpost,net" },
  W_coupled: { name: "Full Coupled-Travel Spring Work", sym: "Wcoupled" },
