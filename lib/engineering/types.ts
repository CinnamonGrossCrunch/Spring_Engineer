 ...
 * scenario state (see lib/v2); Evaluator is a direct, deterministic solve with
 * its own persisted inputs (see lib/evaluator). Switching workspaces never
 * mutates another workspace's state. NOTE: this is deliberately NOT part of
 * PresentationView — these are distinct workflows, not views of one model.
 */
export type WorkspaceVersion = "v1" | "v2" | "evaluator";
