...
export const PARAMETERS: ParameterDefinition[] = [
  ...
  },
  {
    ...
    symbol: "N_a",
    name: "Active coils",
    description: "Number of coils free to deflect.",
    unit: "coils",
    category: "spring-geometry",
    formula: "k ∝ 1/N_a",
  ...
  },
  {
    ...
    name: "Total coils",
    description:
      "Total coil count including inactive end coils. V1 uses the closed-and-ground approximation N_t ≈ N_a + 2 — this depends on end configuration and is not a universal spring law.",
    unit: "coils",
    category: "spring-geometry",
