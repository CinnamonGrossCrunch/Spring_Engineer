...
export const PARAMETERS: ParameterDefinition[] = [
  ...
  },
  {
    ...
    symbol: "x_available",
    name: "Available deflection to maximum solid",
    description: "Total free-length travel available before reaching the tolerance-adjusted maximum solid height.",
    unit: "in",
    category: "constraint",
    formula: "x_available = L_f − H_s,max",
    dependencies: ["L_free", "Hs_max"],
    whatIfIncrease: "Provides more total travel reserve for the same working deflection.",
  },
  {
    id: "deflection_utilization",
    symbol: "u_defl",
    name: "Working deflection utilization",
    description: "Fraction of the available free-to-maximum-solid travel used at the armed/compressed condition.",
    unit: "—",
    category: "constraint",
    formula: "u_defl = x1 / (L_f − H_s,max)",
    dependencies: ["x1", "available_deflection"],
    whatIfIncrease: "Leaves less travel reserve before maximum solid height.",
  },
  {
    id: "deflection_utilization_max",
    symbol: "u_max",
    name: "Maximum deflection utilization",
    description: "Scenario limit for working deflection as a fraction of free-to-maximum-solid travel. The clearance input is an equivalent representation for the current spring.",
    unit: "—",
    category: "constraint",
    min: 0.05,
    max: 0.99,
    step: 0.01,
    formula: "u_defl ≤ u_max",
    dependencies: ["deflection_utilization", "x1", "Hs_max"],
    whatIfIncrease: "Permits operation closer to maximum solid height and reduces required clearance.",
  },
  {
    id: "c_extra",
    symbol: "c_required",
    name: "Required clearance above solid",
    description:
      "Minimum clearance above maximum solid height required by the selected maximum deflection-utilization constraint.",
    unit: "in",
    category: "constraint",
    formula: "c_required = x1·(1/u_max − 1)",
    dependencies: ["x1", "deflection_utilization_max"],
    whatIfIncrease: "Requires more installed length above maximum solid height.",
  },
];
